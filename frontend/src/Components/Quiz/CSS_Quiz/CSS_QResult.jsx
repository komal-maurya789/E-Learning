      ...
      {!submitted ? (
        ...
        <section className="result-wrapper mt-5 mb-5">
          <div className="result-container">
            ...
            <button onClick={() => navigate("/CSS_TutorialDetail")} style={styles.secondaryButton}>Back to Learning</button>
            <button onClick={() => navigate("/CSS_Quiz")} style={styles.secondaryButton}>Retake Quiz</button>
          </div>
        </section>
      )}
    </div>
