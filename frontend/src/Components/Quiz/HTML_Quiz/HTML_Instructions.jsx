    ...
    return (
        <div className="quiz-container mt-5">
            ...
            <div className="quiz-body">
                ...
                <p>
                    Test your knowledge of HTML techniques.
                </p>
                <ul>
                ...
                <button><Link to="/HTML_Quiz" className="start-quiz">Start Quiz</Link></button>
            </div>
        </div>
    );
};
